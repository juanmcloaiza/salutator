...
class EsoClass(QueryWithLogin):
    ...
    def query_tap(self,
        ...
        authenticated : bool, optional
            ...
            :meth:`salutator.eso.EsoClass.login`. Authenticated queries
    ...
    def query_surveys(
        ...
        surveys : str or list, optional
            ...
            names returned by :meth:`~salutator.eso.EsoClass.list_surveys`. If specified
        ...
        authenticated : bool, optional
            ...
            :meth:`~salutator.eso.EsoClass.login`. Authenticated queries may be slower.
            Default is ``False``.
    ...
    def query_main(
        ...
        instruments : str or list, optional
            ...
            names returned by :meth:`~salutator.eso.EsoClass.list_instruments`. If specified
    ...
    def query_instrument(
        ...
        instrument : str
            ...
            :meth:`~salutator.eso.EsoClass.list_instruments`.
        cone_ra : float, optional
            Cone Search Center - Right Ascension in degrees.
        cone_dec : float, optional
            Cone Search Center - Declination in degrees.
        ...
        authenticated : bool, optional
            If ``True``, runs the query as an authenticated user.
            Authentication must be done beforehand via
            :meth:`~salutator.eso.EsoClass.login`. Note that authenticated queries are slower.
            Default is ``False``.
        column_filters : dict or None, optional
            Constraints applied to the query in ADQL syntax,
            e.g., ``{"exp_start": "between '2024-12-31' and '2025-12-31'"}``.
    ...
    def query_apex_quicklooks(self,
        ...
        authenticated : bool, optional
            If ``True``, runs the query as an authenticated user.
            Authentication must be done beforehand via
            :meth:`~salutator.eso.EsoClass.login`. Note that authenticated queries
